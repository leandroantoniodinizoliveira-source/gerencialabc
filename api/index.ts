...
async function runStartupMigration() {
  ...
  try {
    ...
    try {
      ...
      await client.query(`ALTER TABLE pl_plans ADD COLUMN IF NOT EXISTS created_at TIMESTAMP;`);
      await client.query(`ALTER TABLE pl_plans ADD COLUMN IF NOT EXISTS created_by VARCHAR(255);`);
      ...
      await client.query(`ALTER TABLE pl_areas ADD COLUMN IF NOT EXISTS created_at TIMESTAMP;`);
      await client.query(`ALTER TABLE pl_areas ADD COLUMN IF NOT EXISTS created_by VARCHAR(255);`);
      ...
      await client.query(`ALTER TABLE pl_responsibles ADD COLUMN IF NOT EXISTS created_at TIMESTAMP;`);
      await client.query(`ALTER TABLE pl_responsibles ADD COLUMN IF NOT EXISTS created_by VARCHAR(255);`);
